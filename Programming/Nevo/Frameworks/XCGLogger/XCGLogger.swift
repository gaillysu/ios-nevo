...
open class XCGFileLogDestination: XCGBaseLogDestination {
    ...
    ///
    open func rotateFile(_ archiveToFile: AnyObject) -> Bool {
...
open class XCGLogger: CustomDebugStringConvertible {
    ...
    /// - Returns:  Nothing
    ///
    open class func logln(_ closure: @autoclosure () -> Any?, logLevel: LogLevel = .debug, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing
    ///
    open class func logln(_ logLevel: LogLevel = .debug, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line, closure: () -> Any?) {
        self.defaultInstance().logln(logLevel, functionName: functionName, fileName: fileName, lineNumber: lineNumber, closure: closure)
    }
    ...
    /// - Returns:  Nothing
    ///
    open func logln(_ closure: @autoclosure () -> Any?, logLevel: LogLevel = .debug, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    open func logln(_ logLevel: LogLevel = .debug, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line, closure: () -> Any?) {
        logln(logLevel, functionName: String(describing: functionName), fileName: String(describing: fileName), lineNumber: lineNumber, closure: closure)
    }
    ...
    /// - Returns:  Nothing
    ///
    open func logln(_ logLevel: LogLevel = .debug, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line, closure: () -> Any?) {
        ...
        let logDetails: XCGLogDetails = XCGLogDetails(logLevel: logLevel, date: Date(), logMessage: String(describing: closureResult), functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    ...
    /// - Returns:  Nothing.
    ///
    open class func verbose(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open func verbose(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open class func debug(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open func debug(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open class func info(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open func info(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open class func warning(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open func warning(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open class func error(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open func error(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open class func severe(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    /// - Returns:  Nothing.
    ///
    open func severe(_ closure: @autoclosure () -> Any?, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
...
func _try(_ tryClosure: () -> (), catch catchClosure: (_ exception: NSException) -> (), finally finallyClosure: () -> () = {}) {
...
/// - parameter message:  The message to include in the exception (why it occurred)
/// - parameter userInfo: A dictionary with arbitrary info to be passed along with the exception
func _throw(_ name: String, message: String? = nil, userInfo: [AnyHashable: Any]? = nil) {
