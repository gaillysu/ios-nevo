...
public extension Date {
    ...
    static func date(_ year: Int, month: Int, day: Int) -> Date {
        return Date.date(year, month: month, day: day, hour: 0, minute: 0, second: 0)
    }
    
    static func today() -> Date {
        let now = Date()
        return Date.date(now.year, month: now.month, day: now.day)
    }
    ...
    */
    func change(_ weekday: Int) -> Date! {
