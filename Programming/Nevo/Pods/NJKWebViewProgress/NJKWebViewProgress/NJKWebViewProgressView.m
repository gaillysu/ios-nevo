...
-(void)configureViews
{
    ...
    UIColor *tintColor = [UIColor colorWithRed:245.0 / 255.f green:164.f / 255.f blue:28.f / 255.f alpha:1.0]; // iOS7 Safari bar color UIColor(red: 245/255.0, green: 164/255.0, blue: 28/255.0, alpha: 1)
