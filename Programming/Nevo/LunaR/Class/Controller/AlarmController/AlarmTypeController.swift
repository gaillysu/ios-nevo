...
protocol SelectedSleepTypeDelegate {
...
class AlarmTypeController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = "Alarm Type"
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        sleepTypeDelegate?.onSelectedSleepTypeAction(indexPath.row, name: typeArray[indexPath.row])
